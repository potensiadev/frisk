...
// 페이지 데이터 재검증 시간 (5분) - 대학교 목록은 자주 변경되지 않음
export const revalidate = 300;

// 동적 임포트로 초기 번들 크기 감소
const UniversityList = dynamic(() => import('./UniversityList').then(mod => ({ default: mod.UniversityList })), {
  loading: () => <UniversityListSkeleton />,
  ssr: true,
});

function UniversityListSkeleton() {
  return (
